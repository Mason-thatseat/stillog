...
export const BLOCK_CATEGORIES: Array<{ id: string; label: string; types: BlockType[] }> = [
  {
    id: 'structure',
    label: '구조',
    types: ['block_room', 'block_window', 'block_door', 'block_door_in', 'block_door_double', 'block_sliding_door', 'block_wall', 'block_partition'],
  },
  {
    id: 'furniture',
    label: '가구',
    types: ['block_table_2', 'block_table_4', 'block_table_6', 'block_table_round', 'block_seat_point'],
  },
  {
    id: 'facility',
    label: '시설',
